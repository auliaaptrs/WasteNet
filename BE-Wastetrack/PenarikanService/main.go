...
import (
	...
	migrations "wastetrack/PenarikanService/migrations"
	repositories "wastetrack/PenarikanService/repositories"
	routes "wastetrack/PenarikanService/routes"
	usecases "wastetrack/PenarikanService/usecases"
...
func main() {
	...
	penarikanRepo := &repositories.PenarikanRepository{DB: db}

	// Initialize use cases
	penarikanUsecase := &usecases.PenarikanUsecase{PenarikanRepository: penarikanRepo}

	// Initialize controllers
	penarikanController := &controllers.PenarikanController{PenarikanUsecase: penarikanUsecase}
	...
	// Set up routes
	routes.SetupPenarikanRoutes(router, penarikanController)
