...
import 'package:wastetrack/view/login/new_password_view.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Kami telah mengirimkan OTP ke email Anda.",
              ...
              Text(
                "Silakan masukkan email Anda untuk menerima\n tautan guna membuat kata sandi baru melalui email.",
                textAlign: TextAlign.center,
                style: TextStyle(
