...
class _WasteDetailPageState extends State<WasteDetailPage> {
  int selectedTab = 0; // 0: Masuk, 1: Keluar
  ...
  final List<Map<String, dynamic>> masukData = [
    {"name": "Kaleng", "value": 90},
    {"name": "Kaca", "value": 75},
    {"name": "Plastik PET", "value": 70},
    {"name": "Plastik PP", "value": 50},
    {"name": "Kertas Karton", "value": 20},
    {"name": "Styrofoam", "value": 10},
    {"name": "Logam", "value": 5},
    {"name": "Logam", "value": 3},
    {"name": "Logam", "value": 2},
    {"name": "Kaleng", "value": 1},
    {"name": "Kaca", "value": 1},
    {"name": "Plastik PET", "value": 1},
  ];

  final List<Map<String, dynamic>> keluarData = [
    {"name": "Kaleng", "value": 50},
    {"name": "Kaca", "value": 35},
    {"name": "Plastik PET", "value": 30},
    {"name": "Plastik PP", "value": 0},
    {"name": "Kertas Karton", "value": 0},
    {"name": "Styrofoam", "value": 0},
    {"name": "Logam", "value": 0},
    {"name": "Logam", "value": 0},
    {"name": "Logam", "value": 0},
    {"name": "Kaleng", "value": 0},
    {"name": "Kaca", "value": 0},
    {"name": "Plastik PET", "value": 0},
  ];
  ...
  void _onBottomNavTapped(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        Navigator.push(context, MaterialPageRoute(builder: (context) => const HistoriPage()));
        break;
      case 2:
        Navigator.push(context, MaterialPageRoute(builder: (context) => const SetorSampahPage()));
        break;
      case 3:
        break;
    }
  ...
  Widget build(BuildContext context) {
    final data = selectedTab == 0 ? masukData : keluarData;
    ...
    return Scaffold(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 10),
                            Text(
                              "Total Sampah ${selectedTab == 0 ? 'Masuk' : 'Keluar'}",
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        selectedBarIndex = selectedBarIndex == idx ? null : idx;
                                      });
                                    },
                                    child: Stack(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.local_shipping), label: 'Transaksi'),
