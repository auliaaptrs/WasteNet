...
class BuktiKirimSaldoPage extends StatelessWidget {
  final Map<String, dynamic> data;

  const BuktiKirimSaldoPage({super.key, required this.data});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        'Bank Sampah Melati ke $namaPenerima',
                        style: const TextStyle(
